"""
Django settings for WaldmeisterOutdoors project.
...
INSTALLED_APPS = [
    ...
    #'WaldmeisterMap.apps.WaldmeistermapConfig',
    'WaldmeisterMap',
    'django.contrib.gis',
...
ROOT_URLCONF = 'WaldmeisterOutdoors.urls'
...
WSGI_APPLICATION = 'WaldmeisterOutdoors.wsgi.application'
