...
Um die App zu verwenden, sollte die Anleitung auf GitHub (Readme) verwendet werden, oder die .yalm config Datei, um das Projekt auf einer Linux Machine zu builden. $\newline$
$\newline$
Github Repo klonen $\newline$ $\newline$
"npm install" $\newline$ $\newline$
