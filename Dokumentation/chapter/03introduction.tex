...
\subsection{Tests}
Tests für Vue.JS wurden mit dem Test Framework Karma und Jasmin erstellt . Sie können über den Befehl "npm run test" ausgeführt werden. $\newline$

Test für das Django werden mit dem standard Django module "unittest" erstellt
